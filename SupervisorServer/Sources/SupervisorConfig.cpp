...
CSupervisorConfig::CSupervisorConfig()
{
  ...
  webAPIDomainIP_ = r3dReadCFG_S(configFile, group, "webAPIDomainIP", "198.50.173.42");
  webAPIDomainBaseURL_ = r3dReadCFG_S(configFile, group, "webAPIDomainBaseURL", "/conection/vrzapi/");
