...
int CJobProcessUserJoin::Exec() //executa entrada no game
{
...
void CJobProcessUserJoin::OnSuccess()
{
	...
	switch(GameJoinResult)
	{
		...
		case 8: peer.startGameAns = PKT_S2C_StartGameAns_s::RES_noPremium;  break; // user already in game (ResultCode from [WZ_SRV_UserJoinedGame2])RES_noPremium
...
int CJobUpdateChar::Exec()
{
	...
	req.AddParam("GroupID",        slot.GroupID); //ViruZ Group
